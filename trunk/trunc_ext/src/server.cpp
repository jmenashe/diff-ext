...
// {895516D9-4C93-47aa-915D-6EC5C80370E8}
DEFINE_GUID(CLSID_TRUNC_EXT, 0x895516d9, 0x4c93, 0x47aa, 0x91, 0x5d, 0x6e, 0xc5, 0xc8, 0x3, 0x70, 0xe8);
...
DllGetClassObject(REFCLSID rclsid, REFIID riid, void** ppvOut) {
  ...
  *ppvOut = 0;
  ...
  if (IsEqualIID(rclsid, CLSID_TRUNC_EXT)) {
...
SERVER::do_register() {
  ...
  if (StringFromIID(CLSID_TRUNC_EXT, &pwszShellExt) == S_OK) {
